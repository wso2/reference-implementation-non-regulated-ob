...
@JsonTypeName("Response200ForConsentRevocation")
...
public class Response200ForConsentRevocation   {
  ...
  public Response200ForConsentRevocation() {
  }
  ...
  /**
   **/
  public Response200ForConsentRevocation responseId(String responseId) {
    this.responseId = responseId;
    return this;
  }
   ...
   **/
  public Response200ForConsentRevocation status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public Response200ForConsentRevocation data(Object data) {
    this.data = data;
    return this;
  }
   ...
   **/
  public Response200ForConsentRevocation errorCode(Integer errorCode) {
    this.errorCode = errorCode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForConsentRevocation response200ForConsentRevocation = (Response200ForConsentRevocation) o;
    return Objects.equals(this.responseId, response200ForConsentRevocation.responseId) &&
        Objects.equals(this.status, response200ForConsentRevocation.status) &&
        Objects.equals(this.data, response200ForConsentRevocation.data) &&
        Objects.equals(this.errorCode, response200ForConsentRevocation.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForConsentRevocation {\n");
