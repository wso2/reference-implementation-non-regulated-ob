...
public class Response200ForClientProcess   {
  ...
  /**
   **/
  public Response200ForClientProcess responseId(String responseId) {
    this.responseId = responseId;
    return this;
  }
   ...
   **/
  public Response200ForClientProcess status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  /**
   **/
  public Response200ForClientProcess data(FailedResponseClientProcessData data) {
    this.data = data;
    return this;
  }
  ...
  @NotNull @Valid public FailedResponseClientProcessData getData() {
    return data;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForClientProcess response200ForClientProcess = (Response200ForClientProcess) o;
    return Objects.equals(this.responseId, response200ForClientProcess.responseId) &&
        Objects.equals(this.status, response200ForClientProcess.status) &&
        Objects.equals(this.data, response200ForClientProcess.data) &&
        Objects.equals(this.errorCode, response200ForClientProcess.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForClientProcess {\n");
