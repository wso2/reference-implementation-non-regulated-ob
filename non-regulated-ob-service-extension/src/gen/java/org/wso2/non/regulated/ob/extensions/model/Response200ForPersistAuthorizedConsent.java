...
public class Response200ForPersistAuthorizedConsent   {
   ...
   **/
  public Response200ForPersistAuthorizedConsent status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForPersistAuthorizedConsent response200ForPersistAuthorizedConsent = (Response200ForPersistAuthorizedConsent) o;
    return Objects.equals(this.responseId, response200ForPersistAuthorizedConsent.responseId) &&
        Objects.equals(this.status, response200ForPersistAuthorizedConsent.status) &&
        Objects.equals(this.data, response200ForPersistAuthorizedConsent.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForPersistAuthorizedConsent {\n");
