...
@JsonTypeName("Response200ForEventSubscriptionValidation")
...
public class Response200ForEventSubscriptionValidation   {
  ...
  public Response200ForEventSubscriptionValidation() {
  }
  ...
  /**
   **/
  public Response200ForEventSubscriptionValidation responseId(String responseId) {
    this.responseId = responseId;
    return this;
  }
   ...
   **/
  public Response200ForEventSubscriptionValidation status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public Response200ForEventSubscriptionValidation data(Object data) {
    this.data = data;
    return this;
  }
   ...
   **/
  public Response200ForEventSubscriptionValidation errorCode(Integer errorCode) {
    this.errorCode = errorCode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForEventSubscriptionValidation response200ForEventSubscriptionValidation = (Response200ForEventSubscriptionValidation) o;
    return Objects.equals(this.responseId, response200ForEventSubscriptionValidation.responseId) &&
        Objects.equals(this.status, response200ForEventSubscriptionValidation.status) &&
        Objects.equals(this.data, response200ForEventSubscriptionValidation.data) &&
        Objects.equals(this.errorCode, response200ForEventSubscriptionValidation.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForEventSubscriptionValidation {\n");
