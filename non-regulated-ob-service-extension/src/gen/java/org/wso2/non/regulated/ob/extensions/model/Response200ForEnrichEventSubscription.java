...
@JsonTypeName("Response200ForEnrichEventSubscription")
...
public class Response200ForEnrichEventSubscription   {
  ...
  public Response200ForEnrichEventSubscription() {
  }
  ...
  /**
   **/
  public Response200ForEnrichEventSubscription responseId(String responseId) {
    this.responseId = responseId;
    return this;
  }
   ...
   **/
  public Response200ForEnrichEventSubscription status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public Response200ForEnrichEventSubscription data(Object data) {
    this.data = data;
    return this;
  }
   ...
   **/
  public Response200ForEnrichEventSubscription errorCode(Integer errorCode) {
    this.errorCode = errorCode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForEnrichEventSubscription response200ForEnrichEventSubscription = (Response200ForEnrichEventSubscription) o;
    return Objects.equals(this.responseId, response200ForEnrichEventSubscription.responseId) &&
        Objects.equals(this.status, response200ForEnrichEventSubscription.status) &&
        Objects.equals(this.data, response200ForEnrichEventSubscription.data) &&
        Objects.equals(this.errorCode, response200ForEnrichEventSubscription.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForEnrichEventSubscription {\n");
