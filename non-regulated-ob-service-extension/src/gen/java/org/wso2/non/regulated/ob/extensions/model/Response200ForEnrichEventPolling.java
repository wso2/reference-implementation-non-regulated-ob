...
public class Response200ForEnrichEventPolling   {
  ...
  /**
   **/
  public Response200ForEnrichEventPolling responseId(String responseId) {
    this.responseId = responseId;
    return this;
  }
   ...
   **/
  public Response200ForEnrichEventPolling status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public Response200ForEnrichEventPolling data(Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForEnrichEventPolling response200ForEnrichEventPolling = (Response200ForEnrichEventPolling) o;
    return Objects.equals(this.responseId, response200ForEnrichEventPolling.responseId) &&
        Objects.equals(this.status, response200ForEnrichEventPolling.status) &&
        Objects.equals(this.data, response200ForEnrichEventPolling.data) &&
        Objects.equals(this.errorCode, response200ForEnrichEventPolling.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForEnrichEventPolling {\n");
