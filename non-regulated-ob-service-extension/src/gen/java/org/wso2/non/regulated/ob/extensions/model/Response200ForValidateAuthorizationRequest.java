...
public class Response200ForValidateAuthorizationRequest   {
   ...
   **/
  public Response200ForValidateAuthorizationRequest status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public Response200ForValidateAuthorizationRequest data(Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForValidateAuthorizationRequest response200ForValidateAuthorizationRequest = (Response200ForValidateAuthorizationRequest) o;
    return Objects.equals(this.responseId, response200ForValidateAuthorizationRequest.responseId) &&
        Objects.equals(this.status, response200ForValidateAuthorizationRequest.status) &&
        Objects.equals(this.errorCode, response200ForValidateAuthorizationRequest.errorCode) &&
        Objects.equals(this.data, response200ForValidateAuthorizationRequest.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForValidateAuthorizationRequest {\n");
