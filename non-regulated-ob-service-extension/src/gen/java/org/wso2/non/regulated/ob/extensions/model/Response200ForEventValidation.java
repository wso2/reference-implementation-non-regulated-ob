...
@JsonTypeName("Response200ForEventValidation")
...
public class Response200ForEventValidation   {
  ...
  public Response200ForEventValidation() {
  }
  ...
  /**
   **/
  public Response200ForEventValidation responseId(String responseId) {
    this.responseId = responseId;
    return this;
  }
   ...
   **/
  public Response200ForEventValidation status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public Response200ForEventValidation errorCode(Integer errorCode) {
    this.errorCode = errorCode;
    return this;
  }
   ...
   **/
  public Response200ForEventValidation data(Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForEventValidation response200ForEventValidation = (Response200ForEventValidation) o;
    return Objects.equals(this.responseId, response200ForEventValidation.responseId) &&
        Objects.equals(this.status, response200ForEventValidation.status) &&
        Objects.equals(this.errorCode, response200ForEventValidation.errorCode) &&
        Objects.equals(this.data, response200ForEventValidation.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForEventValidation {\n");
