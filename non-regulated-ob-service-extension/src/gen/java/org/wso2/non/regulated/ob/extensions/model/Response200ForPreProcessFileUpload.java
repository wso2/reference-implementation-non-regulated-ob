...
public class Response200ForPreProcessFileUpload   {
  ...
  public Response200ForPreProcessFileUpload() {
  }
   ...
   **/
  public Response200ForPreProcessFileUpload status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public Response200ForPreProcessFileUpload data(Object data) {
    this.data = data;
    return this;
  }
   ...
   **/
  public Response200ForPreProcessFileUpload errorCode(Integer errorCode) {
    this.errorCode = errorCode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForPreProcessFileUpload response200ForPreProcessFileUpload = (Response200ForPreProcessFileUpload) o;
    return Objects.equals(this.responseId, response200ForPreProcessFileUpload.responseId) &&
        Objects.equals(this.status, response200ForPreProcessFileUpload.status) &&
        Objects.equals(this.data, response200ForPreProcessFileUpload.data) &&
        Objects.equals(this.errorCode, response200ForPreProcessFileUpload.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForPreProcessFileUpload {\n");
