...
public class FailedResponseInConsentAuthorize   {
   ...
   **/
  public FailedResponseInConsentAuthorize status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FailedResponseInConsentAuthorize failedResponseInConsentAuthorize = (FailedResponseInConsentAuthorize) o;
    return Objects.equals(this.responseId, failedResponseInConsentAuthorize.responseId) &&
        Objects.equals(this.status, failedResponseInConsentAuthorize.status) &&
        Objects.equals(this.data, failedResponseInConsentAuthorize.data);
  }
