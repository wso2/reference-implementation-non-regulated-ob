...
@JsonTypeName("Response200ForIssueRefreshToken")
...
public class Response200ForIssueRefreshToken   {
  ...
  public Response200ForIssueRefreshToken() {
  }
  ...
  /**
   **/
  public Response200ForIssueRefreshToken responseId(String responseId) {
    this.responseId = responseId;
    return this;
  }
   ...
   **/
  public Response200ForIssueRefreshToken status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public Response200ForIssueRefreshToken data(Object data) {
    this.data = data;
    return this;
  }
   ...
   **/
  public Response200ForIssueRefreshToken errorCode(Integer errorCode) {
    this.errorCode = errorCode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForIssueRefreshToken response200ForIssueRefreshToken = (Response200ForIssueRefreshToken) o;
    return Objects.equals(this.responseId, response200ForIssueRefreshToken.responseId) &&
        Objects.equals(this.status, response200ForIssueRefreshToken.status) &&
        Objects.equals(this.data, response200ForIssueRefreshToken.data) &&
        Objects.equals(this.errorCode, response200ForIssueRefreshToken.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForIssueRefreshToken {\n");
