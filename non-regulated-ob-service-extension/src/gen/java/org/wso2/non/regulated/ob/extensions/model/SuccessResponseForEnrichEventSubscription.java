...
public class SuccessResponseForEnrichEventSubscription   {
  ...
  private SuccessResponseForEnrichEventSubscriptionData data;
  ...
  /**
   **/
  public SuccessResponseForEnrichEventSubscription status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  /**
   **/
  public SuccessResponseForEnrichEventSubscription data(SuccessResponseForEnrichEventSubscriptionData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SuccessResponseForEnrichEventSubscription successResponseForEnrichEventSubscription = (SuccessResponseForEnrichEventSubscription) o;
    return Objects.equals(this.responseId, successResponseForEnrichEventSubscription.responseId) &&
        Objects.equals(this.status, successResponseForEnrichEventSubscription.status) &&
        Objects.equals(this.data, successResponseForEnrichEventSubscription.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SuccessResponseForEnrichEventSubscription {\n");
