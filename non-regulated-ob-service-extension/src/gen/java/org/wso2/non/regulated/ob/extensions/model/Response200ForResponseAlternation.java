...
@JsonTypeName("Response200ForResponseAlternation")
...
public class Response200ForResponseAlternation   {
  ...
  public Response200ForResponseAlternation() {
  }
  ...
  /**
   **/
  public Response200ForResponseAlternation responseId(String responseId) {
    this.responseId = responseId;
    return this;
  }
   ...
   **/
  public Response200ForResponseAlternation status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public Response200ForResponseAlternation data(Object data) {
    this.data = data;
    return this;
  }
   ...
   **/
  public Response200ForResponseAlternation errorCode(Integer errorCode) {
    this.errorCode = errorCode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Response200ForResponseAlternation response200ForResponseAlternation = (Response200ForResponseAlternation) o;
    return Objects.equals(this.responseId, response200ForResponseAlternation.responseId) &&
        Objects.equals(this.status, response200ForResponseAlternation.status) &&
        Objects.equals(this.data, response200ForResponseAlternation.data) &&
        Objects.equals(this.errorCode, response200ForResponseAlternation.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForResponseAlternation {\n");
