...
@JsonTypeName("Response200ForApplicationUpdate")
...
public class Response200ForApplicationUpdate   {
  ...
  public Response200ForApplicationUpdate() {
  }
  ...
  /**
   **/
  public Response200ForApplicationUpdate responseId(String responseId) {
   ...
   **/
  public Response200ForApplicationUpdate status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  /**
   **/
  public Response200ForApplicationUpdate data(SuccessResponseApplicationUpdateData data) {
    this.data = data;
    return this;
  }
  ...
  /**
   **/
  public Response200ForApplicationUpdate errorMessage(FailedResponseApplicationProcessData errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    Response200ForApplicationUpdate response200ForApplicationUpdate = (Response200ForApplicationUpdate) o;
    return Objects.equals(this.responseId, response200ForApplicationUpdate.responseId) &&
        Objects.equals(this.status, response200ForApplicationUpdate.status) &&
        Objects.equals(this.data, response200ForApplicationUpdate.data) &&
        Objects.equals(this.errorMessage, response200ForApplicationUpdate.errorMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class Response200ForApplicationUpdate {\n");
