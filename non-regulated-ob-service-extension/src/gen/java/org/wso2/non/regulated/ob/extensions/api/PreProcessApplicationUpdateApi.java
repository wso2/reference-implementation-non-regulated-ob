...
import org.wso2.non.regulated.ob.extensions.model.AppUpdateProcessRequestBody;
import org.wso2.non.regulated.ob.extensions.model.ErrorResponse;
import org.wso2.non.regulated.ob.extensions.model.Response200ForApplicationUpdate;
...
public class PreProcessApplicationUpdateApi {
    ...
    @ApiOperation(value = "handle pre validations & changes to the manual client application update", notes = "", response = Response200ForApplicationUpdate.class, authorizations = {
